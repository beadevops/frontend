<template>
  <div>
    <b-card style="border-left: 0; border-right:0; border-top:0 ">
      ...
      <chart-portfolio-vulnerabilities ref="chartComponentVulnerabilities" chartId="chartComponentVulnerabilities" class="chart-wrapper" style="height:400px;margin-top:40px;" :height="400"></chart-portfolio-vulnerabilities>
      <div slot="footer">
        <b-row>
          <b-col sm="12" lg="4">
            <b-row>
