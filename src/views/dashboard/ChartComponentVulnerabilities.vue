<template>
  <div class="ChartComponentVulnerabilities">
    <div id="ChartComponentVulnerabilities-content"></div>
  </div>
</template>
  ...
  export default {
    ...
    methods: {
      render (resData) {
        ...
        const myEcharts = echarts.init(document.getElementById('ChartComponentVulnerabilities-content'));
        let colorData = [
          ['#e9cdb3', '#e9cdb3'], // 严重 1
          ['#777777', '#777777'], // 高危 2
        ] // 色块
      ...
      processingData (data) {
        ...
        data.forEach((item, index) => {
          ...
          obj['全部的'].push(item.components);
          obj['脆弱的'].push(item.vulnerableComponents);
        })
        return {xData, obj}
      }
    },
...
<style>
  #ChartComponentVulnerabilities-content {
    width: 100%;
    height: 100%;
  }
</style>
